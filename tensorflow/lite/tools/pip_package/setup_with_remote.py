...
TIIE_DIR = os.environ['TIIE_DIR']
GEN_HEADERS_SCRIPT_PATH = os.path.join(TIIE_DIR, 'parse_messages.py')
...
def gen_headers():
  """Generate headers for remote binding."""
  header = subprocess.check_output([GEN_HEADERS_SCRIPT_PATH, 'interpreter_wrapper2/tflite_messages.yaml'])
  with open('interpreter_wrapper2/tflite_messages.h', 'wb') as fp:
    fp.write(header) 
...
ext = Extension(
    ...
    sources=[
        ...
        'interpreter_wrapper2/interpreter_wrapper2.cc',
        'interpreter_wrapper2/interpreter_wrapper2_pybind11.cc',
        'interpreter_wrapper/numpy.cc',
        'interpreter_wrapper/python_error_reporter.cc',
        'interpreter_wrapper/python_utils.cc',
        'interpreter_wrapper2/tflite_messages.cc',
    ],
    ...
    libraries=[LIB_TFLITE, 'ti_inference_client', 'stdc++fs'],
    library_dirs=[LIB_TFLITE_DIR, TIIE_DIR])
